...
?>
	...
	<a class="fl w-50" href="http://localhost:8888/art-research-adventure/">
    <div class="db aspect-ratio aspect-ratio--1x1 dim">
      <div class="bg-center cover aspect-ratio--object" style="background-image: url(http://localhost:8888/wp-content/uploads/2020/10/dm_2020_bath_uni_edge_300dpi-0428-1-scaled.jpg)">
        <p class="TG black ma0 f4 f3-l pa4 tl lh-title">Art, Research & Adventure</p>
      </div>
    </div>
  </a>

  <!-- <div class="fl w-50">
 	 	<a href="http://localhost:8888/art-research-adventure" class="db aspect-ratio aspect-ratio--1x1 dim">
		<div>

      	<span role="img" style="background-image:url(http://localhost:8888/wp-content/uploads/2020/10/dm_2020_bath_uni_edge_300dpi-0428-1-scaled.jpg);" 
		  class="bg-center cover aspect-ratio--object"></span>
	  	
		<p>Art, Research & Adventure</p>
		</div>
	</a>
  </div> -->
